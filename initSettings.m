...
% Ground Truth in Geodetic system --sbs
settings.truePosition.B     = 22.3198722; % degree
settings.truePosition.L     = 114.209101777778; %degree
settings.truePosition.H     = 0;        % m
